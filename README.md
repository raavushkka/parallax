...
|------------------|---------------|-------------------|
| ![Главная](screenshots/home.png) | ![Каталог](screenshots/catalog.png) | ![Команда](screenshots/team.png) |
...
Работа с данными: Проектирование структуры БД, написание сложных SQL-запросов для отчетов.
