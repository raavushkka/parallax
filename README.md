...
|----------------------------------|---------|---------------------|
| ![Страница фотосессии](screenshots/product.png) | ![Корзина](screenshots/cart.png) | ![Оплата](screenshots/payment.png) |
...
|-------------------------------|------------------------|
| ![Кабинет фотографа](screenshots/photographer.png) | ![Кабинет администратора](screenshots/admin.png) | ![Кабинет администратора](screenshots/lkZapis.png)
