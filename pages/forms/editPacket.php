<div class="personal-cabinet-wrapper mt80">
    ...
    if (isset($_SESSION['USER'])) {
        if ($USER['role'] == 2) {
            ...
            // Получаем данные пакета для редактирования
            if (isset($_GET['id'])) {
                $id = $_GET['id'];
                $sql = "SELECT * FROM `packets` WHERE `id`='$id'";
                $packet = $connect->query($sql)->fetch();
            }
                ...
                <div class="personal-cabinet">
                    ...
                    <div class="cabinet-content">
                        <div class="profile-form">
                            <h2 class="title">редактирование пакета</h2>
                            <form method="post" name="update" class="form">
                                <div class="form-group">
                                    <label for="name" class="form-label">введите название</label>
                                    <input type="text" id="name" class="form-input" placeholder="название" name="name" value="<?= $name ?? $packet['name'] ?>" maxlength="20">
                                    <?
                                    if (isset($_POST['update'])) {
                                        if (empty($name)) {
                                            $flag = false;
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="duration" class="form-input" placeholder="от 2 часов" name="duration" value="<?= $duration ?? $packet['duration'] ?>" maxlength="20">
                                    <?
                                    if (isset($_POST['update'])) {
                                        if (empty($duration)) {
                                            $flag = false;
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sources" class="form-input" placeholder="до 200 шт" name="sources" value="<?= $sources ?? $packet['sources'] ?>" maxlength="20">
                                    <?
                                    if (isset($_POST['update'])) {
                                        if (empty($sources)) {
                                            $flag = false;
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="processing" class="form-input" placeholder="15-20 кадров" name="processing" value="<?= $processing ?? $packet['processing'] ?>" maxlength="16">
                                    <?
                                    if (isset($_POST['update'])) {
                                        if (empty($processing)) {
                                            $flag = false;
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rent" class="form-input" placeholder="бесплатно" name="rent" value="<?= $rent ?? $packet['rent'] ?>" maxlength="15">
                                    <?
                                    if (isset($_POST['update'])) {
                                        if (empty($rent)) {
                                            $flag = false;
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="stylist" class="form-input" placeholder="6 образов" name="stylist" value="<?= $stylist ?? $packet['stylist'] ?>" maxlength="11">
                                    <?
                                    if (isset($_POST['update'])) {
                                        if (empty($stylist)) {
                                            $flag = false;
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="visagiste" class="form-input" placeholder="макияж" name="visagiste" value="<?= $visagiste ?? $packet['visagiste'] ?>" maxlength="11">
                                    <?
                                    if (isset($_POST['update'])) {
                                        if (empty($visagiste)) {
                                            $flag = false;
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="price" class="form-input" placeholder="8000" name="price" value="<?= $price ?? $packet['price'] ?>" maxlength="11">
                                    <?
                                    if (isset($_POST['update'])) {
                                        if (empty($price)) {
                                            $flag = false;
            ...
            if (isset($_POST['update'])) {
                if ($flag) {
                    ...
                    if ($result) {
                        ...
                        echo '<p class="error">Ошибка при обновлении пакета</p>';
                    }
                }
            }
        } else {
